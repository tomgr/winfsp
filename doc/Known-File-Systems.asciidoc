...
- https://github.com/buildbarn/bb-remote-execution[buildbarn] - A bazel-compatible remote execution client that uses WinFSP to provide a virtual directory for performing builds
